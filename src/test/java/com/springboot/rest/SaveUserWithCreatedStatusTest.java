...
public class SaveUserWithCreatedStatusTest {
        @Autowired
	...
	@Test
	public void testSaveUserwithCreatedStatus() throws Exception {
            String exampleUserJson = "{\"firstName\": \"Jon\",\"lastName\": \"Snow\",\"userName\": \"hemal@itmusketeers.com\",\"password\": \"123456\"}";
